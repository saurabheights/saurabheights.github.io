...
Enhance your Pelican powered blog with more features! This guide walks you through integrating Giscus comments, an auto-generated Table of Contents and Latex support to easily render equations. Step by step, you’ll learn how to make your technical blog more interactive and user-friendly.
...
If you’re new to Pelican and haven’t yet set up your portfolio blog, I recommend checking out my earlier blog: [How to Build a Portfolio Website with Pelican](https://saurabheights.github.io/building-website-using-pelican.html). That post covers the initial setup so you can follow this article without confusion.

Pelican, being a lightweight yet highly customizable static site generator, offers the flexibility to add these features without bloating your site. In this guide, we’ll focus on few enhancements that significantly improve the usability and appeal of a technical blog:
...
* **Giscus integration** to provide an interactive comment section for GitHub users to discuss and leave feedback.
...
To add a Table of Content in Pelican, you can use the [pelican-toc](https://github.com/ingwinlu/pelican-toc/) plugin. This plugin automatically scans your article headings (`<h2>`, `<h3>`, etc.) and generates a structured TOC that appears on your page.

Let’s clone the **pelican-toc** plugin repository into the `plugins` directory of your project.
...
You can find the template at `themes/Flex/templates/article.html`. I added the TOC block inside the `<article class="single">` container as shown below:
```html
{% if article.toc %}
  <div class="toc">
...
To implement scrollspy, I added the following script inside my `article.html` file at the end.
```html
<script>
...
Once enabled, you can use LaTeX syntax inside your Markdown or reStructuredText files. Use `$...$` for inline math and `$$...$$` for block equations.
...
Finally, rebuild your site and refresh your blog, you should now see the Giscus comment box rendered at the bottom of every article.